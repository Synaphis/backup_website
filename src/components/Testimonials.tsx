...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    name: "James Fanzon",
    title: "IT Director - Creditspring",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16 items-stretch">
          {testimonials.map((testimonial, index) => (
            <blockquote
              key={index}
              className={twMerge(
                "p-6 flex flex-col justify-between h-full bg-[#A1CCA6]/10 rounded-2xl border border-[#A1CCA6]/30 backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1",
