    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="relative flex items-center justify-center">
          {/* Banner behind logo */}
         <div className="absolute -inset-y-4 -inset-x-6 rounded-b-xl bg-gradient-to-r from-[#1B3C53] via-[#234C6A] to-[#456882] opacity-40 -z-10 shadow-[0_0_60px_rgba(255,255,255,0.15)]" />
          ...
          <a href="/" className="relative flex items-center justify-center">
            <Image
              ...
              width={120}
              height={120}
              className="relative h-40 w-40 drop-shadow-[0_0_25px_rgba(255,255,255,0.6)]"
              priority
            />
          </a>
        </div>
